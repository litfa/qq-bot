  ...
  onMessage(async (data: Data) => {
    ...
    if (types.includes(data.data?.type)) {
      ...
      const sqlData = {
        ...
        subject_nickname: message?.subject?.nickname,
        subject_remark: message?.subject?.remark,
        subject_name: message?.subject?.name,
        subject_permission: message?.subject?.permission,
        subject_member_name: message?.subject?.memberName,
        subject_special_title: message?.subject?.specialTitle,
        subject_join_timestamp: message?.subject?.joinTimestamp,
        subject_last_speak_timestamp: message?.subject?.lastSpeakTimestamp,
        subject_mute_time_remaining: message?.subject?.muteTimeRemaining,
        subject_group_id: message?.subject?.group?.id,
        subject_group_name: message?.subject?.group?.name,
        subject_group_permission: message?.subject?.group?.permission,
