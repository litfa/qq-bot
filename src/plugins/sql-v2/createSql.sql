...
create table bot_join_group_event (
  ...
  invitor__join_timestamp int null,
  invitor__last_speak_timestamp int null,
  invitor__mute_time_remaining int null,
  invitor__group__id int null,
...
create table bot_leave_event_disband (
  ...
  operator__join_timestamp int null,
  operator__last_speak_timestamp int null,
  operator__mute_time_remaining int null,
  operator__group__id int null,
...
create table member_card_change_event (
  ...
  member__join_timestamp int null,
  member__last_speak_timestamp int null,
  member__mute_time_remaining int null,
  member__group__id int null,
...
create table temp_sync_message (
  ...
  subject__join_timestamp int null,
  subject__last_speak_timestamp int null,
  subject__mute_time_remaining int null,
  subject__group__id int null,
